...
@Singleton
class TopicController @Inject() (val userService: UserService,
...
//                ThreadPostData(request.user._id, DateTime.now), 1, false, false, None)
...
//          }
//        }.flatten(NotFound("Not Found")))
//  }
//
//  def showTopic(id: String) = OptionalSessionApiAction.async {
//    implicit request =>
//      showTopicData(id).flatten(NotFound("Not Found"))
//  }
//
//  private def showTopicData(id: String)(implicit maybeUser: Option[User]): FutureOption[Result] = for {
