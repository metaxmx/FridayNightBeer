...
trait GenericNumericKeyDAO[T] extends GenericDAO[T, Int] {
  ...
  def insertOptimistic(entity: T)(implicit idReader: BaseModelIdReader[T, Int], idWriter: BaseModelIdWriter[T, Int],
  ...
  def getNextId(implicit idReader: BaseModelIdReader[T, Int], reader: BSONDocumentReader[T], cp: CursorProducer[T]): Future[Int] =
  ...
  def <<(entity: T)(implicit idReader: BaseModelIdReader[T, Int], idWriter: BaseModelIdWriter[T, Int],
                    reader: BSONDocumentReader[T], writer: BSONDocumentWriter[T],
